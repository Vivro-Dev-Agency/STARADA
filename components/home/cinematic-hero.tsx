...
export function CinematicHero() {
  ...
  useGSAP(
    () => {
      ...
      // Elements start at opacity-0 in CSS so they never flash visible before GSAP.
      tl.fromTo(
        ".hero-word",
        { yPercent: 110, autoAlpha: 0 },
        { yPercent: 0, autoAlpha: 1, duration: 1.1, stagger: 0.12 },
      )
        .fromTo(".hero-sub", { y: 28, autoAlpha: 0 }, { y: 0, autoAlpha: 1, duration: 0.9 }, "-=0.55")
        .fromTo(
          ".hero-image",
        ...
        .fromTo(".hero-cta", { y: 16, autoAlpha: 0 }, { y: 0, autoAlpha: 1, duration: 0.7 }, "-=0.45");
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden bg-obsidian">
        <div className="hero-image absolute inset-0 scale-105 opacity-0 will-change-transform">
          <Image
      ...
      <div className="container-luxury relative z-10 px-6 md:px-10 lg:px-16">
        <div className="max-w-3xl">
          <p className="hero-meta mb-6 text-xs tracking-[0.3em] text-gold uppercase opacity-0">
            Morocco · Casablanca
          </p>

          <h1 className="font-display text-5xl leading-[0.95] text-champagne md:text-7xl lg:text-8xl">
            <span className="block overflow-hidden">
              <span className="hero-word inline-block opacity-0">Drive the</span>
            </span>
            <span className="block overflow-hidden">
              <span className="hero-word text-gradient-gold inline-block opacity-0">Extraordinary</span>
            </span>
          </h1>

          <p className="hero-sub mt-6 max-w-lg text-base leading-relaxed text-champagne/70 opacity-0 md:text-lg">
          ...
          <div className="hero-meta mt-14 flex flex-wrap gap-8 border-t border-gold/15 py-8 opacity-0 md:gap-12">
            <div>
